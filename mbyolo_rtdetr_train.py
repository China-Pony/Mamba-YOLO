...
def parse_opt():
    ...
    parser.add_argument('--config', type=str, default=ROOT + '/ultralytics/cfg/models/mamba-yolo/rtdetr-mamba.yaml', help='model path(s)')
    ...
    parser.add_argument('--warmup_epochs', type=float, default=20, help='warmup epochs')
    ...
    parser.add_argument('--pretrained', action='store_false', help='use pretrained weight')
